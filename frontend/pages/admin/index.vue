    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="card p-4">
        ...
        <div class="space-y-2">
          ...
          <NuxtLink to="/admin/messages" class="flex items-center gap-2 p-3 rounded-md hover:bg-surface-2 transition-colors text-sm"><Icon name="mdilocal:message-alert-outline" class="w-4 h-4 text-accent-2" /> User Messages</NuxtLink>
